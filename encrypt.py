...
def encrypt(data):
	...
	f = open('static/keys_kr.txt','w+')
	for a in Kr:
		f.write(str(a) + '\n')
	f.close
	f = open('static/keys_kc.txt','w+')
	for a in Kc:
		f.write(str(a) + '\n')
	f.close
	f = open('static/keys_itemmax.txt','w+')
	...
	im.save('static/encrypted_images/' + data)

	return 'Encrypt Completed'
