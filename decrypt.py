...
def decrypt(data):
    im = Image.open('static/encrypted_images/' + data)
    pix = im.load()
    ...
    #Key kc
    f = open('static/keys_itemmax.txt', 'r')
    ...
    im.save('static/decrypted_images/' + data)

    return 'Decrypt Completed'
